...
registerAuthRoutes(app); registerCompanyRoutes(app); registerCompanyIntelligenceRoutes(app); registerCompany360Routes(app); registerLiveMarketRoutes(app); registerMarketHistoryRoutes(app); registerAIChatRoutes(app);
