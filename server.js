...
let verifiedMarketData = {
  ...
  equities: [
    ...
    },
    {
      ...
      low: "5,270.00",
      high: "5,347.50",
      fiftyTwoHigh: "₹6,388.50",
      fiftyTwoLow: "₹4,671.50",
      pe: "19.4",
      mcap: "₹1,05,470 Cr",
    ...
    },
    {
      ...
      low: "1,31,000.00",
      high: "1,32,250.00",
      fiftyTwoHigh: "₹1,51,280.00",
      fiftyTwoLow: "₹1,18,000.00",
      pe: "23.6",
      mcap: "₹55,700 Cr",
      corpAction: "Standard Settlement",
      verifiedSource: "NSE Official Bhavcopy",
    ...
    },
    {
      ...
      low: "3,875.00",
      high: "3,920.00",
      fiftyTwoHigh: "₹4,592.00",
      fiftyTwoLow: "₹3,520.00",
      pe: "26.4",
      mcap: "₹14,08,000 Cr",
      corpAction: "Standard Settlement",
      verifiedSource: "NSE Official Bhavcopy",
...
app.post('/api/analyze', (req, res) => {
  ...
  if (equity) {
    const analysis = `I am Buddy. Here is the verified dossier for ${equity.name}. Last traded official closing price on NSE is ₹${equity.price}, registering a change of ${equity.netChange} (${equity.change}). 52-week range spans ${equity.fiftyTwoLow} to ${equity.fiftyTwoHigh}. Valuation P/E is ${equity.pe} with a total market capitalization of ${equity.mcap}. Note: ${equity.corpAction}.`;
    return res.json({
      success: true,
      aiName: "Buddy",
      found: true,
